...
> Recently revised in **2020-09-28 21:24:27**
...
| &emsp;[4.1 JSON.parse(JSON.stringify())](#chapter-four-one) |
| &emsp;[4.2 函数库 Lodash](#chapter-four-two) |
| &emsp;[4.3 五 框架 jQuery](#chapter-four-three) |
<!-- 目录结束 -->
...
* `Array.prototype.concat(target)`：`concat()` 是数组的一个内置方法，用户合并两个或者多个数组。这个方法不会改变现有数组，而是返回一个新数组。
...
### <a name="chapter-four-one" id="chapter-four-one"></a>4.1 JSON.parse(JSON.stringify())
...
### <a name="chapter-four-two" id="chapter-four-two"></a>4.2 函数库 Lodash
...
### <a name="chapter-four-three" id="chapter-four-three"></a>4.3 五 框架 jQuery
