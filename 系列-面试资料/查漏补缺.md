...
| <a name="catalog-chapter-three" id="catalog-chapter-three"></a>[三 算法](#chapter-three) |
| <a name="catalog-chapter-four" id="catalog-chapter-four"></a>[四 设计模式](#chapter-four) |
<!-- 目录结束 -->
...
## <a name="chapter-three" id="chapter-three"></a>三 算法
...
## <a name="chapter-four" id="chapter-four"></a>四 设计模式
