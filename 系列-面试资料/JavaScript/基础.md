...
> Recently revised in **2020-10-25 21:14:36**
...
| <a name="catalog-chapter-six" id="catalog-chapter-six"></a>[六 事件流](#chapter-six) |
| &emsp;[6.1 原理](#chapter-six-one) |
| &emsp;[6.2 案例](#chapter-six-two) |
| &emsp;[6.3 练习题](#chapter-six-three) |
| &emsp;[6.4 阻止冒泡](#chapter-six-four) |
| &emsp;[6.5 onmouseover 和 onmouseenter 区别](#chapter-six-five) |
| &emsp;[6.6 科普](#chapter-six-six) |
...
| <a name="catalog-chapter-fourteen" id="catalog-chapter-fourteen"></a>[十四 函数式编程](#chapter-fourteen) |
| &emsp;[14.1 函数式编程特点](#chapter-fourteen-one) |
| &emsp;[14.2 纯函数](#chapter-fourteen-two) |
| <a name="catalog-chapter-fifteen" id="catalog-chapter-fifteen"></a>[十五 渐进式网络应用（PWA）](#chapter-fifteen) |
| &emsp;[15.1 优点](#chapter-fifteen-one) |
| &emsp;[15.2 缺点](#chapter-fifteen-two) |
| <a name="catalog-chapter-sixteen" id="catalog-chapter-sixteen"></a>[十六 规范化](#chapter-sixteen) |
| &emsp;[16.1 CommonJS 规范](#chapter-sixteen-one) |
| &emsp;[16.2 AMD 规范](#chapter-sixteen-two) |
| &emsp;[16.3 CMD 规范](#chapter-sixteen-three) |
| &emsp;[16.4 ES6 Modules 规范](#chapter-sixteen-four) |
| <a name="catalog-chapter-seventeen" id="catalog-chapter-seventeen"></a>[十七 babel 编译原理](#chapter-seventeen) |
| <a name="catalog-chapter-eighteen" id="catalog-chapter-eighteen"></a>[十八 题集](#chapter-eighteen) |
| &emsp;[18.1 数组常见 API](#chapter-eighteen-one) |
| &emsp;[18.2 常见 DOM API](#chapter-eighteen-two) |
| &emsp;[18.3 数组去重](#chapter-eighteen-three) |
| &emsp;[18.4 数字化金额](#chapter-eighteen-four) |
| &emsp;[18.5 遍历问题](#chapter-eighteen-five) |
| &emsp;[18.6 setTimeout](#chapter-eighteen-six) |
| &emsp;[18.7 requestAnimationFrame](#chapter-eighteen-seven) |
| &emsp;[18.8 暂时性死区](#chapter-eighteen-eight) |
| &emsp;[18.9 输出打印结果](#chapter-eighteen-night) |
| &emsp;[18.10 输出打印结果](#chapter-eighteen-ten) |
| &emsp;[18.11 Event Loop](#chapter-eighteen-eleven) |
| &emsp;[18.12 输出打印结果](#chapter-eighteen-twelve) |
| &emsp;[18.13 使 a == 1 && a == 2 成立](#chapter-eighteen-thirteen) |
| <a name="catalog-chapter-nighteen" id="catalog-chapter-nighteen"></a>[十九 More](#chapter-nighteen) |
<!-- 目录结束 -->
...
## <a name="chapter-six" id="chapter-six"></a>六 事件流
...
### <a name="chapter-six-three" id="chapter-six-three"></a>6.3 练习题
...
### <a name="chapter-six-four" id="chapter-six-four"></a>6.4 阻止冒泡
...
### <a name="chapter-six-five" id="chapter-six-five"></a>6.5 onmouseover 和 onmouseenter 区别

> [返回目录](#chapter-one)

![图](https://img2018.cnblogs.com/blog/1670358/201909/1670358-20190918160838058-597135305.png)

这两者都是移入的时候触发，但是 `onmouseover` 会触发多次，而 `onmouseenter` 只在进去的时候才触发。

### <a name="chapter-six-six" id="chapter-six-six"></a>6.6 科普
...
## <a name="chapter-fourteen" id="chapter-fourteen"></a>十四 函数式编程
...
### <a name="chapter-fourteen-one" id="chapter-fourteen-one"></a>14.1 函数式编程特点
...
### <a name="chapter-fourteen-two" id="chapter-fourteen-two"></a>14.2 纯函数
...
就好比在 React 的 `jsx` 页面中，如果你要操作某部分数据，你有两种方法：

1. 在 `return (<JSX></JSX>)` 调用之前定义好你的函数
2. 在 `return (<JSX></JSX>)` 中尽可能使用 JS API。
...
export class index extends Component {
  render() {
    ...
    // 定义方法
    const listMap = (data) => {
      // 如果需要修改数据，那么先拷贝一份副本，免得污染数据
      // 项目中可能使用 lodash 在 reducers.js 中获取接口数据后就计算好了
...
## <a name="chapter-fifteen" id="chapter-fifteen"></a>十五 渐进式网络应用（PWA）

> [返回目录](#chapter-one)

渐进式网络应用（PWA）是谷歌在 2015 年底提出的概念。基本上算是 Web 应用程序，但在外观和感觉上与原生 App 类似。支持 PWA 的网站可以提供脱机工作、推送通知和设备硬件访问等功能。

### <a name="chapter-fifteen-one" id="chapter-fifteen-one"></a>15.1 优点
...
### <a name="chapter-fifteen-two" id="chapter-fifteen-two"></a>15.2 缺点
...
## <a name="chapter-sixteen" id="chapter-sixteen"></a>十六 规范化
...
### <a name="chapter-sixteen-one" id="chapter-sixteen-one"></a>16.1 CommonJS 规范

> [返回目录](#chapter-one)

这之后，就有了 `CommonJS` 规范，它的特点，其实我们见得不少，就是 `Node` 的那套：
...
### <a name="chapter-sixteen-two" id="chapter-sixteen-two"></a>16.2 AMD 规范
...
### <a name="chapter-sixteen-three" id="chapter-sixteen-three"></a>16.3 CMD 规范
...
### <a name="chapter-sixteen-four" id="chapter-sixteen-four"></a>16.4 ES6 Modules 规范
...
## <a name="chapter-seventeen" id="chapter-seventeen"></a>十七 babel 编译原理
...
## <a name="chapter-eighteen" id="chapter-eighteen"></a>十八 题集

> [返回目录](#chapter-one)

### <a name="chapter-eighteen-one" id="chapter-eighteen-one"></a>18.1 数组常见 API
...
### <a name="chapter-eighteen-two" id="chapter-eighteen-two"></a>18.2 常见 DOM API
...
### <a name="chapter-eighteen-three" id="chapter-eighteen-three"></a>18.3 数组去重
...
### <a name="chapter-eighteen-four" id="chapter-eighteen-four"></a>18.4 数字化金额
...
### <a name="chapter-eighteen-five" id="chapter-eighteen-five"></a>18.5 遍历问题
...
### <a name="chapter-eighteen-six" id="chapter-eighteen-six"></a>18.6 setTimeout
...
### <a name="chapter-eighteen-seven" id="chapter-eighteen-seven"></a>18.7 requestAnimationFrame
...
### <a name="chapter-eighteen-eight" id="chapter-eighteen-eight"></a>18.8 暂时性死区
...
### <a name="chapter-eighteen-night" id="chapter-eighteen-night"></a>18.9 输出打印结果
...
### <a name="chapter-eighteen-ten" id="chapter-eighteen-ten"></a>18.10 输出打印结果
...
### <a name="chapter-eighteen-eleven" id="chapter-eighteen-eleven"></a>18.11 Event Loop
...
### <a name="chapter-eighteen-twelve" id="chapter-eighteen-twelve"></a>18.12 输出打印结果
...
### <a name="chapter-eighteen-thirteen" id="chapter-eighteen-thirteen"></a>18.13 使 a == 1 && a == 2 成立
...
## <a name="chapter-nighteen" id="chapter-nighteen"></a>十九 More
