...
> Recently revised in **2020-11-14 17:48:45**
...
| &emsp;[2.1 创建自定义事件](#chapter-two-one) |
| &emsp;[2.2 事件的监听](#chapter-two-two) |
| &emsp;[2.3 事件的触发](#chapter-two-three) |
| &emsp;[2.4 案例](#chapter-two-four) |
...
### <a name="chapter-two-one" id="chapter-two-one"></a>2.1 创建自定义事件
...
### <a name="chapter-two-two" id="chapter-two-two"></a>2.2 事件的监听
...
### <a name="chapter-two-three" id="chapter-two-three"></a>2.3 事件的触发
...
### <a name="chapter-two-four" id="chapter-two-four"></a>2.4 案例
