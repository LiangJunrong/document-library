...
> Recently revised in **2020-10-12 00:10:02**
...
如果不能理解那也没关系，下面 **jsliang** 手把手亲自教学。
...
出来了出来了，呼应前言，我们通过 `prototype` 定义了构造函数 `Person` 的小区公共健身房，这样区里邻居（实例 `person1` 和 `person2`）就都可以过去健身了。
