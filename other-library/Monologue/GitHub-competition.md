...
> Recently revised in **2019-10-09 15:50:10**
...
每周日会进行当周结算（上周日——本周六），将漏卡总金额以红包形式发给大家当福利（金额 = 漏卡总金额 / 参赛人数）。同时，接受下一周的竞赛参与（周日——下周六）。

---

4、**特殊说明**

**jsliang** 会根据参赛情况，按月形式（按周参与的每满 4 次请自觉发红包~）收取 6.66 元监督费（劳苦费），如果你觉得不合理，请忽略该竞赛。
