...
> Recently revised in **2019-09-23 19:28:11**
...
OK，到这里，我们应该清楚，跳码就是根据某个样板，来计算 XXXS、XXS、XS、S、M、L、XL、XXL 之间的一个档差。
...
那么，在代码上，如何根据 sampleSize、jumpRule、rule 来动态计算，从而得到最终的 rule 呢？
