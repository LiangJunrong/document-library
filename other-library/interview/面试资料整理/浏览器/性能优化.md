...
> Recently revised in **2020-10-03 15:52:44**
...
| &emsp;[3.1 针对 Webpack 本身构建优化](#chapter-three-one) |
| &emsp;&emsp;[3.1.1 优化 resolve.modules 配置](#chapter-three-one-one) |
| &emsp;&emsp;[3.1.2 优化 resolve.extensions 配置](#chapter-three-one-two) |
| &emsp;[3.2 通过 Loader 和 Plugin 优化](#chapter-three-two) |
| &emsp;&emsp;[3.2.1 babel-loader](#chapter-three-two-one) |
| &emsp;&emsp;[3.2.2 tree shaking](#chapter-three-two-two) |
| &emsp;&emsp;[3.2.3 可视化分析](#chapter-three-two-three) |
| &emsp;&emsp;[3.2.4 缓存](#chapter-three-two-four) |
| &emsp;&emsp;[3.2.5 多进程](#chapter-three-two-five) |
| &emsp;&emsp;[3.2.6 抽离](#chapter-three-two-six) |
| &emsp;&emsp;[3.2.7 多进程代码压缩](#chapter-three-two-seven) |
| &emsp;&emsp;[3.2.8 拆包](#chapter-three-two-eight) |
| &emsp;[3.3 打包资源压缩](#chapter-three-three) |
| &emsp;[3.4 按需加载](#chapter-three-four) |
| &emsp;[3.5 优化体验](#chapter-three-five) |
...
| <a name="catalog-chapter-eleven" id="catalog-chapter-eleven"></a>[十一 性能监控](#chapter-eleven) |
...
| &emsp;[13.1 11懒加载](#chapter-thirteen-one) |
| &emsp;[13.2 11可视区域渲染](#chapter-thirteen-two) |
| <a name="catalog-chapter-fourteen" id="catalog-chapter-fourteen"></a>[十四 负载均衡](#chapter-fourteen) |
| <a name="catalog-chapter-fifteen" id="catalog-chapter-fifteen"></a>[十五 参考文献](#chapter-fifteen) |
| &emsp;[15.1 1Webpack 优化](#chapter-fifteen-one) |
| &emsp;[15.2 1其他优化](#chapter-fifteen-two) |
<!-- 目录结束 -->
...
### <a name="chapter-three-one" id="chapter-three-one"></a>3.1 针对 Webpack 本身构建优化

> [返回目录](#chapter-one)

#### <a name="chapter-three-one-one" id="chapter-three-one-one"></a>3.1.1 优化 resolve.modules 配置
...
#### <a name="chapter-three-one-two" id="chapter-three-one-two"></a>3.1.2 优化 resolve.extensions 配置
...
### <a name="chapter-three-two" id="chapter-three-two"></a>3.2 通过 Loader 和 Plugin 优化

> [返回目录](#chapter-one)

#### <a name="chapter-three-two-one" id="chapter-three-two-one"></a>3.2.1 babel-loader

> [返回目录](#chapter-one)

以 `babel-loader` 为例，可以通过 `include` 和 `exclude` 帮助我们避免 `node_modules` 这类庞大文件夹。

#### <a name="chapter-three-two-two" id="chapter-three-two-two"></a>3.2.2 tree shaking

> [返回目录](#chapter-one)

通过 ES6 的 `import/export` 来检查未引用代码，以及 `sideEffects` 来标记无副作用代码，最后用 `UglifyJSPlugin` 来做 `tree shaking`，从而删除冗余代码。

#### <a name="chapter-three-two-three" id="chapter-three-two-three"></a>3.2.3 可视化分析
...
#### <a name="chapter-three-two-four" id="chapter-three-two-four"></a>3.2.4 缓存
...
#### <a name="chapter-three-two-five" id="chapter-three-two-five"></a>3.2.5 多进程

> [返回目录](#chapter-one)

`Happypack` 可以将任务分解成多个子进程去并发执行，大大提升打包效率。

#### <a name="chapter-three-two-six" id="chapter-three-two-six"></a>3.2.6 抽离
...
#### <a name="chapter-three-two-seven" id="chapter-three-two-seven"></a>3.2.7 多进程代码压缩
...
#### <a name="chapter-three-two-eight" id="chapter-three-two-eight"></a>3.2.8 拆包
...
### <a name="chapter-three-three" id="chapter-three-three"></a>3.3 打包资源压缩
...
### <a name="chapter-three-four" id="chapter-three-four"></a>3.4 按需加载
...
### <a name="chapter-three-five" id="chapter-three-five"></a>3.5 优化体验
...
## <a name="chapter-eleven" id="chapter-eleven"></a>十一 性能监控
...
### <a name="chapter-thirteen-one" id="chapter-thirteen-one"></a>13.1 11懒加载
...
### <a name="chapter-thirteen-two" id="chapter-thirteen-two"></a>13.2 11可视区域渲染
...
## <a name="chapter-fourteen" id="chapter-fourteen"></a>十四 负载均衡
...
### <a name="chapter-fifteen-one" id="chapter-fifteen-one"></a>15.1 1Webpack 优化
...
### <a name="chapter-fifteen-two" id="chapter-fifteen-two"></a>15.2 1其他优化
