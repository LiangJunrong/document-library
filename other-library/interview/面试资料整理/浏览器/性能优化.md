...
| <a name="catalog-chapter-eleven" id="catalog-chapter-eleven"></a>[十一 预加载页面资源](#chapter-eleven) |
| <a name="catalog-chapter-twelve" id="catalog-chapter-twelve"></a>[十二 长列表](#chapter-twelve) |
| &emsp;[12.1 懒加载](#chapter-twelve-one) |
| &emsp;[12.2 可视区域渲染](#chapter-twelve-two) |
| <a name="catalog-chapter-thirteen" id="catalog-chapter-thirteen"></a>[十三 负载均衡](#chapter-thirteen) |
...
要说起前端性能优化，其实我们可以从 “输入 URL 到页面呈现” 这里边讲起。
...
我们需要知道的是解析的开始步骤：**浏览器缓存** -> **系统缓存（host）** -> **路由器缓存**
...
## <a name="chapter-eleven" id="chapter-eleven"></a>十一 预加载页面资源
...
## <a name="chapter-twelve" id="chapter-twelve"></a>十二 长列表

> [返回目录](#chapter-one)

### <a name="chapter-twelve-one" id="chapter-twelve-one"></a>12.1 懒加载
...
### <a name="chapter-twelve-two" id="chapter-twelve-two"></a>12.2 可视区域渲染
...
## <a name="chapter-thirteen" id="chapter-thirteen"></a>十三 负载均衡
