...
> Recently revised in **2020-03-31 17:34:59**
...
## <a name="chapter-seven" id="chapter-seven">七 自平衡树：AVL 树和黑红树</a>

> [返回目录](#chapter-one)

## <a name="chapter-eight" id="chapter-eight">八 小结</a>

> [返回目录](#chapter-one)

## <a name="chapter-night" id="chapter-night">九 题集</a>

> [返回目录](#chapter-one)

## <a name="chapter-ten" id="chapter-ten">事 参考文献</a>
