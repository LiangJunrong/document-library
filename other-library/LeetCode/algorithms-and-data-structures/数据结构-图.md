...
> Recently revised in **2020-4-4 22:58:47**
...
```js
const Dictionary = require('./temp.js');
...
## <a name="chapter-six" id="chapter-six">六 图的遍历</a>
...
### <a name="chapter-six-one" id="chapter-six-one">6.1 广度优先搜索</a>
...
### <a name="chapter-six-two" id="chapter-six-two">6.2 【优化】广度优先搜索</a>
...
### <a name="chapter-six-three" id="chapter-six-three">6.3 深度优先搜索</a>

> [返回目录](#chapter-one)


### <a name="chapter-six-four" id="chapter-six-four">6.4 【优化】深度优先搜索</a>

> [返回目录](#chapter-one)


### <a name="chapter-six-five" id="chapter-six-five">6.5 其他算法</a>
