...
> Recently revised in **2020-3-22 12:07:52**
...
| &emsp;[3.1 has()](#chapter-three-one) |
| &emsp;[3.2 add()、remove()](#chapter-three-two) |
| &emsp;[3.3 clear()、size()、values()](#chapter-three-three) |
| &emsp;[3.4 union()](#chapter-three-four) |
| &emsp;[3.5 intersection()](#chapter-three-five) |
| &emsp;[3.6 difference()](#chapter-three-six) |
| &emsp;[3.7 subset()](#chapter-three-seven) |
...
无论是在 LeetCode 的刷题过程中，疑惑中工作过程中，我们都会使用到 ES6 的 `Set`，使用到这个集合操作。
