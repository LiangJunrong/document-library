...
**回答**：每个人的学习经历是不同的，所拥有的技术、知识点以及工作经验等都是不同的。
...
**回答**：每个人的目的都是不同的，不可能一篇文章写完所有知识点，同时有些知识点可能 **jsliang** 也不感兴趣，并且每个面试官都可能有自己的一套面试题，如果 **jsliang** 能将所有的面试题都写出来，那还需要面试官做啥呢？大家都像考国家证书一样直接电脑考试吧~（我也期待！！！）
