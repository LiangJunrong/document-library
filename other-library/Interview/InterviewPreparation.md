...
> Recently revised in **2019-2-23 22:17:52**

周末工作：

1. 整理一下已收集的面试资料
2. 梳理一下知识点，将大纲目录列举出来
3. 整理一下自己所做的项目，列出编写流程，其中困点、难点，以及自己的项目开发所用的一套
4. 如果前三点都做好了，那么在细化一两个常用点

首先，关于面试考点，打算从下面这些点进行剖析：
...
因为我想找的工作是使用 Vue 的工作，然后其中可能涉及原生代码，最重要的是需要有面向对象的编程思维。
