...
> Recently revised in **2019-08-23 19:57:09**
...
| &emsp;[3.3 参数 - 中央处理器（CPU）](#chapter-three-three) |
...
### <a name="chapter-three-three" id="chapter-three-three">3.3 参数 - 中央处理器（CPU）</a>

> [返回目录](#chapter-one)

中央处理器（CPU）是电脑中最重要的部件。

中央处理器（CPU）目前有两大厂商：AMD 和 Intel。相对应的即是 APU 和 CPU，但是你看 **jsliang** 的标题就知道了，建议购买的还是 Intel 的 CPU 处理器。
