  ...
  <script>
    window.onload = function () {
      ...
      $('#input').bind("input propertychange", function (event) {
        ...
        console.log(PinyinMatch.match(text, input)); // [1, 3]
        const area = PinyinMatch.match(text, input);
        if (area) {
          $('#text').html(`${text.slice(0, area[0])}<span style="color: red">${text.slice(area[0], area[1] + 1)}</span>${text.slice(area[1] + 1)}`);
        }
      });
    };
  </script>
  ...
  return function (n) {
    ...
    return i.m = n, i.c = e, i.d = function (n, e, a) {
      ...
      if (i.r(a), Object.defineProperty(a, "default", {
        ...
        for (var u in n) i.d(a, u, function (e) {
          return n[e]
        }.bind(null, u));
      return a
    }, i.n = function (n) {
    ...
    var a = i(0).pinyin_dict_notone,
      ...
      o = function () {
        var n = {};
        for (var e in a)
          for (var i = a[e], u = 0, o = i.length; u < o; u++) n[i[u]] ? n[i[u]] = n[i[u]] + " " + e : n[i[u]] = e;
        return n
      }(),
      t = {};
    ...
    function f(n, e, i) {
      for (var a = n.length, u = 0; u < e.length; u++) {
        var o = e[u],
          t = o.length,
          r = t === i.length;
        if (t <= a)
          for (var g = 0; a - g >= t;) {
            for (var f = !0, c = 0, l = 0, s = 0; s < o.length; s += 1)
              if (0 === s && " " === n[g + s + c]) c += 1, s -= 1;
              else if (" " === n[g + s + l]) l += 1, s -= 1;
            else if (!h(n[g + s + l], o[s], !n[g + s + 1] || !o[s + 1], r)) {
              g += 1, f = !1;
              break
            }
            if (f) return [g + c, g + l + s - 1]
          }
      }
      return !1
    }
