...
> Recently revised in **2019-10-16 12:38:04**
...
在查资料丰富这系列知识的过程中，我们还有一些知识点忽略了探索，要不然我们会产生更多的疑惑，最终像 **jsliang** 一样通宵达旦到晚上 04:00 还在精神抖擞折腾~

但是，由于跟小伙伴们约定好了，要完结这个系列的文章，所以 **jsliang** 忽略了一些知识点。

可能这份文章不是最全面的，但是 **jsliang** 感觉能够满足小伙伴们基础了解的，至于更多的，例如手写一个 `Object.assign()` 或者了解 Lodash 的深拷贝源码，后期我们再探索啦~
