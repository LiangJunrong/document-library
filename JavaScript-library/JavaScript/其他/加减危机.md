...
> Recently revised in **2019-11-25 19:20:41**
...
### <a name="chapter-four-two" id="chapter-four-two"></a>4.2 弥补方法一
...
const multiplication = (arg1, arg2) => {
  ...
  // 思考：为什么一个数除于 Math.pow(10, baseNum) 是安全的？
  // https://www.soinside.com/question/EUFpKw7fr6vrhXT46ATCEB
};
...
console.log(subtraction(0.01, 1)); // 0.2
...
const division = (arg1, arg2) => {
  const num1Changed = floatToInt(arg1);
  const num2Changed = floatToInt(arg2);
  checkSafeNumber(num1Changed);
  checkSafeNumber(num2Changed);
  return multiplication((num1Changed / num2Changed), revise(Math.pow(10, digitLength(arg2) - digitLength(arg1))));
};
...
console.log(0.02 / 0.1); // 0.19999999999999998
console.log(division(0.02, 0.1)); // 0.2

console.log(1.02 / 1.1); // 0.9272727272727272
console.log(division(1.02, 1.1)); // 数字 9272727272727272 超限，请注意风险！0.9272727272727272

console.log(1207.41 * 100);
console.log((multiplication(1207.41, 100) - multiplication(1000, 100)) / 100);

```

### <a name="chapter-four-three" id="chapter-four-three"></a>4.3 弥补方法二
...
* [《PHP Float 浮点型 - Manual》](https://www.php.net/manual/zh/language.types.float.php)
* [《Java 您的小数点到哪里去了？ - Brian Goetz》](https://www.ibm.com/developerworks/cn/java/j-jtp0114/index.html)
* [《处理货币价值，将数字除以100是否安全？ - SO中文参考》](https://www.soinside.com/question/EUFpKw7fr6vrhXT46ATCEB)
